...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto absolute right-0 top-0 w-full z-50 outline-none focus:outline-none bg-neutral-800/70">
